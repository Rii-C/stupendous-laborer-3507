...
dispatch(GetData)
    ...
    const HandleLeft = ()=>{
        let one = document.getElementById('eight8')
...
// console.log(carouselData,"this is carouselData")
    ...
    return (
<>
<h1 className={styles.head}>Workout Essentials</h1>
        ...
        <div id='eight8' className={styles.carousel}>

{carouselData && 
carouselData.map((el,index)=>{
    if(el.code==="workout_essentials"){
