...
const WhyHealth = () => {
  return (
    <div style={{width:"80%" , margin:"auto", }}>
        <Text fontWeight="600"  fontSize={25} justifyContent={"flex-start"} marginBottom="20px">Why HealthKart ?</Text>
        <div>
            <Flex justifyContent={"space-between"}  >
                <Stack spacing={4}>
                    <Image w={"35%"} src="https://img9.hkrtcdn.com/20791/normal_2079088_o.png" alt="wide"/>
                    <Text fontWeight="500" >Wide range of Nutritional products</Text>
                    <Text>One-stop fitness and health destination</Text>
                </Stack >
                <Stack spacing={4} >
                    <Image w={"35%"} src="https://img3.hkrtcdn.com/20791/normal_2079092_o.png" alt="wide"/>
                    <Text fontWeight="500" >100% Original & Authentic</Text>
                    <Text>Tight control on sourcing and distribution</Text>
                </Stack >
                <Stack spacing={4} >
                    <Image w={"35%"} src="https://img1.hkrtcdn.com/20791/normal_2079090_o.png" alt="wide"/>
